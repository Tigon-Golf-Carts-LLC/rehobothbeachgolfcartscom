...
export default function LocationSchema({ 
  ...
  useEffect(() => {
    const baseStructuredData = {
      ...
      "@type": "LocalBusiness",
      "name": `Rehoboth Beach Golf Carts - ${municipalityName} ${municipalityType}`,
      ...
      "url": `https://rehobothbeachgolfcarts.com/${municipalityName.toLowerCase().replace(/\s+/g, '-')}-${municipalityType.toLowerCase()}-golf-carts`,
      "logo": "https://rehobothbeachgolfcarts.com/attached_assets/Rehoboth Beach Golf Carts_1753809066045.png",
      "image": "https://rehobothbeachgolfcarts.com/attached_assets/Rehoboth Beach Golf Carts_1753809066045.png",
    ...
    if (pageType === 'rental') {
      const rentalSchema = {
        ...
        "description": `Professional golf cart rentals in ${municipalityName} ${municipalityType}, Sussex County. Daily, weekly, and monthly rental options available for events, recreation, and personal use.`,
        "url": `https://rehobothbeachgolfcarts.com/${municipalityName.toLowerCase().replace(/\s+/g, '-')}-${municipalityType.toLowerCase()}-rentals`,
        "hasOfferCatalog": {
          "@type": "OfferCatalog",
